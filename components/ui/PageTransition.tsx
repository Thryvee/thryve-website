  ...
  return (
    <>
      ...
      <div style={{
        ...
        background: 'var(--text)',
        transform: stage === 'idle' ? 'scaleX(0)' : stage === 'in' ? 'scaleX(1)' : 'scaleX(0)',
        transformOrigin: stage === 'in' ? 'left' : 'right',
        transition: stage === 'idle' ? 'none' : 'transform 0.4s cubic-bezier(0.87,0,0.13,1)',
        ...
        <div style={{
          ...
          fontWeight: 500, color: 'rgba(250,250,250,0.15)',
