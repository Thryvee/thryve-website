...
const service = getServicePage("ecommerce-acquisition")!;
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/services/ecommerce-acquisition",
  },
  openGraph: {
    url: `${siteUrl}/services/ecommerce-acquisition`,
    title: service.metaTitle,
    description: service.metaDescription,
  },
};
...
export default function EcommerceAcquisitionPage() {
  return (
    <>
      <script
